...
for k in cost_of_pandemic2.__dict__:
    print(k, " ", locale.format_string("%d", cost_of_pandemic2.__dict__[k], grouping=True))
...
# Should have 5 items in the dict, each representing costs. Short term economic costs should be 0. Health costs should be higher than above. 
for k in cost_of_pandemic3.__dict__:
    print(k, " ", locale.format_string("%d", cost_of_pandemic3.__dict__[k], grouping=True))