...
DEATHS_ACTUARIAL_TABLE = {"DE": [
    ...
    # age aove 85 extrapolated using  https://www.scielo.br/j/rbepop/a/NqgRHmJDNYPM7zGsJCNCQMG/?lang=en&format=pdf multiplied by 1.25 to adjust to match rates on tail end 
