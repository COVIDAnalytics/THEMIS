...
def region_policy_scatter_plot(results:pd.DataFrame, region_name:str, start_date:str = "3/15/2020", currency_symbol:str = "\N{EURO SIGN}"):
    fig = px.scatter(results.query("start_date == @start_date"), 
                    x='st_economic_costs', y='num_deaths', color='is_actual', 
                    ...
                    labels={
                        'st_economic_costs': 'Economic Costs', 'num_deaths': 'Number of Deaths', "is_actual": "Scenario Type",
                    },
